...
public class ProductModuleController {
    ...
    @PostMapping
    public ResponseEntity<Response> insertProductModule(@RequestBody ProductModuleWrapper wrapper) throws Exception {
        ProductModuleWrapper data = productModuleService.save(wrapper);
    ...
    public ResponseEntity<Response> findById(@PathVariable("id") Long id) throws Exception {
        ProductModuleWrapper data = productModuleService.findById(id);
    ...
    public ResponseEntity<Response> delete(@RequestParam Long id) throws Exception {
        Boolean data = productModuleService.delete(id);
    ...
    public ResponseEntity<Response> findAll() throws Exception {
        List<ProductModuleWrapper> data = productModuleService.findAll();
